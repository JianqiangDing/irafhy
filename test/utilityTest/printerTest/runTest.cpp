...
TEST_F(PrinterTest, PrinterTest_2d_Test)
{
	irafhy::Printer::write({}, this->intervalHulls_, "demoOutFileWithoutTime.txt");
}

TEST_F(PrinterTest, PrinterTest__2dWithTime_Test)
{
	irafhy::Printer::write(this->time_, this->intervalHulls_, "demoOutFileWithTime.txt");
}