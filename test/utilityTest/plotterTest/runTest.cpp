...
TEST_F(PlotterTest, PlotterTest_2d_Test)
{
	irafhy::Plotter::plot({}, this->intervalHulls_, {0, 1});
}

TEST_F(PlotterTest, PlotterTest_2d_withTime_Test)
{
	irafhy::Plotter::plot(this->time_, this->intervalHulls_, {1});
}