...
class  settingsParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleTimeHorizonsetting = 0, RuleStepSetting = 1, RuleGeometrysetting = 2, 
    RulePlotsetting = 3, RulePrintsetting = 4, RuleAnalysissetting = 5, 
    RuleMaxjumpsetting = 6, RuleStartmodelidsetting = 7, RuleInitialconditionsetting = 8, 
    RuleSetting = 9, RuleCondition = 10, RulePolytope = 11, RuleHpolytope = 12, 
    RuleVpolytope = 13, RuleMatrix = 14, RuleVector = 15, RuleIntervalhull = 16, 
    RuleConstraints = 17, RuleConstraint = 18, RuleSystem = 19, RuleFormula = 20, 
    RuleInterval = 21, RuleConst_expression = 22, RuleExpression = 23
  };

  settingsParser(antlr4::TokenStream *input);
  ~settingsParser();
  ...
  class TimeHorizonsettingContext;
  class StepSettingContext;
  class GeometrysettingContext;
  class PlotsettingContext;
  class PrintsettingContext;
  class AnalysissettingContext;
  class MaxjumpsettingContext;
  class StartmodelidsettingContext;
  class InitialconditionsettingContext;
  ...
  class  TimeHorizonsettingContext : public antlr4::ParserRuleContext {
  public:
    TimeHorizonsettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_TIME_HORIZON();
  ...
  TimeHorizonsettingContext* timeHorizonsetting();

  class  StepSettingContext : public antlr4::ParserRuleContext {
  public:
    StepSettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_STEP();
    antlr4::tree::TerminalNode *DEFINE();
  ...
  StepSettingContext* stepSetting();

  class  GeometrysettingContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *VALUE = nullptr;;
    GeometrysettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_GEOMETRY();
    antlr4::tree::TerminalNode *DEFINE();
  ...
  GeometrysettingContext* geometrysetting();

  class  PlotsettingContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *SWITCH = nullptr;;
    PlotsettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_PLOT_FLAG();
    antlr4::tree::TerminalNode *DEFINE();
    antlr4::tree::TerminalNode *KEY_SWITCH_ON();
    antlr4::tree::TerminalNode *KEY_SWITCH_OFF();
  ...
  class  PrintsettingContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *SWITCH = nullptr;;
    PrintsettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_PRINT_FLAG();
    antlr4::tree::TerminalNode *DEFINE();
    antlr4::tree::TerminalNode *KEY_SWITCH_ON();
    antlr4::tree::TerminalNode *KEY_SWITCH_OFF();
  ...
  PrintsettingContext* printsetting();

  class  AnalysissettingContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *ANALYSIS = nullptr;;
    AnalysissettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_ANALYSIS();
    antlr4::tree::TerminalNode *DEFINE();
    antlr4::tree::TerminalNode *KEY_ANALYSIS_FORWARD();
    antlr4::tree::TerminalNode *KEY_ANALYSIS_BACKWARD();
  ...
  AnalysissettingContext* analysissetting();

  class  MaxjumpsettingContext : public antlr4::ParserRuleContext {
  public:
    MaxjumpsettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_MAX_JUMP();
    antlr4::tree::TerminalNode *DEFINE();
    antlr4::tree::TerminalNode *NUMBER();
  ...
  MaxjumpsettingContext* maxjumpsetting();

  class  StartmodelidsettingContext : public antlr4::ParserRuleContext {
  public:
    StartmodelidsettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_START_MODEL_ID();
    antlr4::tree::TerminalNode *DEFINE();
  ...
  StartmodelidsettingContext* startmodelidsetting();

  class  InitialconditionsettingContext : public antlr4::ParserRuleContext {
  public:
    InitialconditionsettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_INITIAL_CONDITION();
    antlr4::tree::TerminalNode *DEFINE();
  ...
  InitialconditionsettingContext* initialconditionsetting();

  class  SettingContext : public antlr4::ParserRuleContext {
  public:
    SettingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY_SETTINGS();
    antlr4::tree::TerminalNode *LEFTCURLYBRACKET();
    antlr4::tree::TerminalNode *RIGHTCURLYBRACKET();
    std::vector<TimeHorizonsettingContext *> timeHorizonsetting();
    TimeHorizonsettingContext* timeHorizonsetting(size_t i);
    std::vector<StepSettingContext *> stepSetting();
    StepSettingContext* stepSetting(size_t i);
    std::vector<PlotsettingContext *> plotsetting();
    PlotsettingContext* plotsetting(size_t i);
    std::vector<PrintsettingContext *> printsetting();
    PrintsettingContext* printsetting(size_t i);
    std::vector<AnalysissettingContext *> analysissetting();
    AnalysissettingContext* analysissetting(size_t i);
    std::vector<GeometrysettingContext *> geometrysetting();
    GeometrysettingContext* geometrysetting(size_t i);
    std::vector<MaxjumpsettingContext *> maxjumpsetting();
    MaxjumpsettingContext* maxjumpsetting(size_t i);
    std::vector<StartmodelidsettingContext *> startmodelidsetting();
    StartmodelidsettingContext* startmodelidsetting(size_t i);
    std::vector<InitialconditionsettingContext *> initialconditionsetting();
    InitialconditionsettingContext* initialconditionsetting(size_t i);
