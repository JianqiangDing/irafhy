...
class  definitionParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleCondition = 0, RulePolytope = 1, RuleHpolytope = 2, RuleVpolytope = 3, 
    RuleMatrix = 4, RuleVector = 5, RuleIntervalhull = 6, RuleConstraints = 7, 
    RuleConstraint = 8, RuleSystem = 9, RuleFormula = 10, RuleInterval = 11, 
    RuleConst_expression = 12, RuleExpression = 13
  };

  definitionParser(antlr4::TokenStream *input);
  ~definitionParser();
