...
public:
  ...
  enum {
    ...
    RuleConst_expression = 15, RuleExpression = 16, RuleModelid = 17, RuleFlows = 18, 
    RuleInvariantcondition = 19, RuleModel = 20, RuleLocations = 21, RuleDirection = 22, 
    RuleGuardcondition = 23, RuleUpdatefunction = 24, RuleResetmap = 25, 
    RuleJump = 26, RuleTransitions = 27
  };
